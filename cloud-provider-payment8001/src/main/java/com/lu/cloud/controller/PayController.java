...
public class PayController {
    ...
    public String getInfoByConsul(@Value("${lu.config}") String atguiguInfo) {
        return "atguiguInfo: " + atguiguInfo + "\t" + "port: " + port;
    }

    @PostMapping(value = "/nccloud/api/feedback")
    public JSONObject feedback(@RequestBody JSONObject jsonObject) {
